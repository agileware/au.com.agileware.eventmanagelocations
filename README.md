...
* Only users with the **Event manage locations: edit locations** permission (see [Permissions](#permissions)
...
This extension adds a new CiviCRM permission with the machine name `edit locations`, shown to
administrators as **Event manage locations: edit locations** (the extension's own name is
prefixed to the label, matching the convention used by other CiviCRM extensions), described as
"Allows users to edit event locations".
